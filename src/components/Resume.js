            ...
            <Box component="header" className={classes.mainContainer}>
                ...
                <Typography variant="h2" className={`${classes.timeLineYear} ${classes.timeLineItem}`}>About Me</Typography>
                    ...
                    <Box component="div" className={classes.timeLineItem}>
                        ...
                        align="center"  // add color
                        style={{color: "#00FFFF"}}>                       
                            Own and operate 3 locations with the Cottage Inn Pizza franchise. Recruited, hired, and trained new employees, including monitoring and reviewing of individual performance. Oversea all departments with over 35 employees, streamlined efficiency, reduced labor hours, and boost profitability to optimize overall productivity. Remained calm and professional in stressful circumstances and when dealing with unhappy customers, effectively diffusing situations. Cross-trained in every store role to maximize operational knowledge. Extended existing customer relationships through extensive communication and tried-and-true marketing strategies. Established ambitious goals for employees to promote and surpass business targets. Strengthened product branding initiatives and coordinated effective marketing campaigns. Forecast trends in expected business levels and adjusted labor and inventory to match expectations. Increased overall team efficiency and productivity. Addressed internal and customer-related issues each day and affected strategic resolutions. Coordinated and launched grand openings for new stores. Drove profit increases by leveraging market knowledge and natural leadership talents. Collaborated with staff to maximize customer satisfaction, streamline procedures, and improve bottom-line profitability.Monitored supplier operations to verify quality, delivery schedule, and conformance to contract specifications.Ran daily reports to assess performance and make proactive adjustments.Established, enforced, and updated policies keeping business agile and responsive to changing market conditions.
                        </Typography>
